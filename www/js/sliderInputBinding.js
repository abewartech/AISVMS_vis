...
var sliderInputBinding = new Shiny.InputBinding();

// An input binding must implement these methods
$.extend(sliderInputBinding, {
  ...
  subscribe: function(el, callback) {
    $(el).on('keyup.sliderInputBinding input.sliderInputBinding', function(event) {
      callback(true);
...
Shiny.inputBindings.register(sliderInputBinding, 'shiny.sliderInput');
